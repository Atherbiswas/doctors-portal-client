  ...
  return (
    <div className="hero bg-base-100 mt-10">
      <div className="hero-content flex-col lg:flex-row">
        <img
          src={care}
          className="rounded-lg shadow-2xl lg:w-96"
        alt=""/>
        <div className="lg:mx-14">
          ...
          <button className="btn btn-primary bg-gradient-to-r from-primary to-secondary text-white"><span className="text-sm">Get Started</span></button>
        </div>
      </div>
    </div>
  );
